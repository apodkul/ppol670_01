...
admissions <- read.csv("https://github.com/apodkul/ppol670_01/raw/main/Data/Admissions_missing.csv") %>% 
...
library(sqldf)
wine_data <- read.csv("https://github.com/apodkul/ppol670_01/raw/main/Data/wine_quality.csv")
