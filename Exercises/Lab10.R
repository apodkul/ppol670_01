...
### Load Data 
admissions <- read.csv("https://github.com/apodkul/ppol670_01/raw/main/Data/Admission.csv")
...
#New data
housing <- read.csv('https://github.com/apodkul/ppol670_01/raw/main/Data/BostonHousing.csv')
