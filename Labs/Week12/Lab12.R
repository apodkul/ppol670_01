...
admissions <- read.csv("https://raw.githubusercontent.com/apodkul/ppol670_01/main/Labs/Week12/Admissions_missing.csv") %>% 
...
library(sqldf)
wine_data <- read.csv("https://raw.githubusercontent.com/apodkul/ppol670_01/main/Labs/Week12/wine_quality.csv")
