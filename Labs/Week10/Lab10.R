...
### Load Data 
admissions <- read.csv("https://raw.githubusercontent.com/apodkul/ppol670_01/main/Labs/Week10/Admission.csv")
...
#New data
housing <- read.csv('https://raw.githubusercontent.com/apodkul/ppol670_01/main/Labs/Week10/BostonHousing.csv')
